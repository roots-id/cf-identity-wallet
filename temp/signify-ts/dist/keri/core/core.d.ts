...
export declare const VEREX = "(KERI|ACDC)([0-9a-f])([0-9a-f])([A-Z]{4})([0-9a-f]{6})_";
 ...
 */
export declare function deversify(versionString: string): [Ident, Serials, Version, string];
export declare function versify(ident?: Ident, version?: Version, kind?: Serials, size?: number): string;
